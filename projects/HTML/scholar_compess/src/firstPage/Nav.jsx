      ...
      <div className="flex">
        <div className="flex-none md:hidden">
          <div className="dropdown">
            ...
            <ul tabIndex={0} className="menu menu-sm dropdown-content text-lightDev rounded-box z-50 mt-3 w-52 p-2 shadow bg-lightBg">
              <input type="text" placeholder="Search" className="input input-bordered bg-lightBg border-sky-500 rounded-xl w-full" />
              <li><a>Home</a></li>
              <li><a>Service</a></li>
              <li><a>Courses</a></li>
              <li><a>Team</a></li>
        ...
        <div className="gap-2 shrink hidden md:flex">
          <input type="text" placeholder="Search" className="input input-bordered w-24 lg:w-auto" />
        </div>
      </div>
