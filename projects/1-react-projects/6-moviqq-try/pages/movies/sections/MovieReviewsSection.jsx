...
import MovieRateSection from "./MovieRateSection";
...
const MovieReviewsSection = () => {
  ...
  useEffect(() => {
    if (movieId) dispatch(GetMovieReviews({ movieId }));
  }, [movieId]);

  const reviews = MovieReviewsDetails?.results || [];

  const getAvatarUrl = (avatar) => {
    if (!avatar) return "/Image-not-found.png";
  ...
  return (
    <section className="my-10 px-4 container lg:ml-8">
      ...
      {MovieReviewsDetails?.total_results > 3 && (
