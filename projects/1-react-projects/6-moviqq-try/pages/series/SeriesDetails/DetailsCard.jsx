          ...
          >
            ...
            >
              ...
              <p className="text-sm text-gray-300 flex items-center gap-2">
                ...
                First aired: {selectedSeriesDetails?.first_air_date} • Last
            ...
            >
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span>
                    <strong className="text-red-500">Seasons:</strong>{" "}
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span>
                    <strong className="text-red-500">Episodes:</strong>{" "}
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span>
                    ...
                    {selectedSeriesDetails?.production_countries?.map(
                      (country, inx) => (
                        <span key={inx}>{country.name}</span>
                      )
                    )}
                  </span>
                </div>
                <div className="flex items-center gap-2">
                  ...
                  <span>
                    ...
                    {selectedSeriesDetails?.genres?.map((g) => (
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span>
                    <strong className="text-red-500">Country:</strong>{" "}
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span>
                    <strong className="text-red-500">Duration:</strong>{" "}
                    {selectedSeriesDetails?.episode_run_time?.[0]} min
                  </span>
                </div>
                <div className="flex items-center gap-2">
                  ...
                  <span>
                    ...
                    {selectedSeriesDetails?.vote_count} votes)
                  </span>
                </div>
              </motion.div>
              ...
              <div className="flex flex-wrap gap-4">
                <button
                  onClick={() => {
                    dispatch(getSeriesTrailer(selectedSeriesDetails?.id));
              ...
              >
                ...
                <p className="text-gray-400 text-sm mb-4">
                  Official and social media links related to this series
                </p>
