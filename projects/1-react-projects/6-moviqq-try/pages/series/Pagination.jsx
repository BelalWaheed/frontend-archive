...
const Pagination = () => {
  ...
  return (
    ...
    >
      ...
      >
        <button
          onClick={() => dispatch(getSeries({ page: page - 10, type: typing }))}
        ...
        <button
          onClick={() => dispatch(getSeries({ page: page - 1, type: typing }))}
        ...
        <button
          onClick={() => dispatch(getSeries({ page: page + 1, type: typing }))}
          disabled={seriesLoading || page >= totalPages || page >= 500}
          color="red"
          variant="text"
          className="!p-2 sm:!p-3 rounded-full hover:bg-red-700/40 active:scale-90 
                     transition-all duration-200"
        ...
        <button
          onClick={() => dispatch(getSeries({ page: page + 10, type: typing }))}
          disabled={seriesLoading || page + 10 > totalPages || page + 10 > 500}
          color="red"
          variant="text"
          className="!p-2 sm:!p-3 rounded-full hover:bg-red-700/40 active:scale-90 
                     transition-all duration-200"
