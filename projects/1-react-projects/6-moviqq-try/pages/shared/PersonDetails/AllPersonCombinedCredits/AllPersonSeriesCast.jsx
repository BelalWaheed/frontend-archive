...
const AllPersonSeriesCast = () => {
  ...
  useEffect(() => {
    ...
    dispatch(GetPersonDetails({ personId: localStorage.getItem("personId") }));
  }, []);
      ...
      >
        ...
        <div className="flex-1 space-y-4 flex flex-col justify-center">
          ...
          {PersonDetails?.birthday && (
            <p className="text-sm text-gray-500">🎂 {PersonDetails.birthday}</p>
          )}
        </div>
      </div>
            ...
            >
              ...
              <CardBody className="p-3 text-white space-y-2">
                ...
                <p className="text-xs text-gray-400">
                  {series.first_air_date || series.release_date || "N/A"}
                </p>
              </CardBody>
            </Card>
          </div>
